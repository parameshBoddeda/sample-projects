...
import InternationalCopyFilteredList from "./InternationalCopyFilteredList";
...
const InternationalTraffickingCopyUI = (props) => {
  ...
  const [checkedBreak, setCheckedBreak] = useState(false);
...
const getAssetData = (_marketType, _venturized, _mediaType) => {
  ...
  // useEffect(() => {
  //   if (props.currentScheduleAdUnit) {
  //     getAssetData();
  //   }
  ...
  const handleFilter = () => {
    ...
    if (!v) {
      ...
      let params = {
        ...
        // status: statusValue === 0 || statusValue ? statusValue : -1,
      };
  ...
  const checkValidation = () => {
    ...
    if (!(checkedIsci || checkedBreak) && props.currentScheduleAdUnit !== -1) {
      notifyWarning("Please select ISCI or Break/Position");
      error = true;
    }
  ...
  const handleBreakCheck = (e) => {
    setCheckedBreak(e.target.checked);
  };
                ...
                {props.selectedScheduleData != null &&
                  props.selectedScheduleData !== undefined && (
                    <Typography color="primary" variant="caption" ml={2}>
                      {`
                                ${
                                  props.selectedScheduleData.isGameSchedule ===
                                  1
                                    ? "Game"
                                    : "Non-Game"
                                } |
                            ...
                            <Box display="flex" alignItems="center">
                              ...
                              <Typography variant="caption">
                                {props.currentSelectedIsci
                                  ? props.currentSelectedIsci.title
                                  : ""}
                              </Typography>
                            </Box>
                          </TableCell>
                          ...
                          <TableCell>
                            <Box display="flex" alignItems="center">
                              <Checkbox
                                size="small"
                                className={classes.checkboxPadding}
                                onChange={(e) => handleBreakCheck(e)}
                                checked={checkedBreak}
                              />
                              <Typography variant="caption">
                                {`${
                                  props.currentSelectedBreak
                                    ? props.currentSelectedBreak.label
                                    : ""
                                }`}
                              </Typography>
                            </Box>
...
InternationalTraffickingCopyUI.displayName = "InternationalTraffickingCopyUI";
export default InternationalTraffickingCopyUI;
